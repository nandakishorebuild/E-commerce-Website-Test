      ...
      <div className="min-h-[90vh] flex flex-col-reverse md:flex-row items-center justify-center gap-8 md:gap-16 px-6 md:px-10 py-10 md:py-0 bg-gradient-to-r from-blue-50 to-purple-100">
        ...
        <div className="w-full md:max-w-xl text-center md:text-left">
          ...
          <button
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white text-base md:text-lg font-semibold px-10 py-3 md:py-4 rounded-full shadow-xl active:scale-95 transition-all duration-200 w-fit md:w-auto"
          >
            Shop Now
          </button>
        </div>
        ...
        <div className="w-full md:w-1/2 flex justify-center">
          <img
            ...
            alt="shopping"
            className="w-64 md:w-[500px] h-full hover:scale-105 transition duration-300"
          />
        </div>
