  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="flex flex-col justify-center items-center min-h-[90vh] text-center px-4">
        ...
        {/* Description */}
        <p className="text-gray-500 text-lg max-w-xl leading-relaxed mb-3">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-2">
          ...
          <div className="bg-white rounded-xl shadow px-6 py-5 w-52 flex flex-col items-center gap-2">
